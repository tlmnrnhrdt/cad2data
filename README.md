...
<h3 align="center">CAD/BIM (Revit, DWG, IFC, DGN) processing and conversion with batch handling, grouping, checks, and QTO reports.</br> Visualization of automation processes in open workflows</h3>
